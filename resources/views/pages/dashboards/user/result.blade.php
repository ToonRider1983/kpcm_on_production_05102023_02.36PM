<x-default-layout>
    ...
    <div class="container">
        <div class="h2 p-4">User Master - Result</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 text-lg-start col-md-5 text-md-start col-8 text-start">
                              @if ($user->user_privilege_project)
                                <span class="text-white fw-bold fs-6" style="background-color: #2295EB; border-radius: 4px; padding: 3px;">Project</span>
                            @endif
                            @if ($user->user_privilege_service)
                                <span class="text-white fw-bold fs-6" style="background-color: #34B913; border-radius: 4px; padding: 3px;">Customer Service</span>
                            @endif
                            @if ($user->user_privilege_maintain)
                                <span class="text-white fw-bold fs-6" style="background-color: #9D22B3; border-radius: 4px; padding: 3px;">Maintenance</span>
                            @endif
                            @if ($user->user_privilege_judge)
                                <span class="text-white fw-bold fs-6" style="background-color: #F53E32; border-radius: 4px; padding: 3px;">Judge</span>
                            @endif
                            @if ($user->user_privilege_editall)
                                <span class="text-white fw-bold fs-6" style="background-color: #FCC005; border-radius: 4px; padding: 3px;">Edit All</span>
                            @endif
                        </div>
                    </div>
                </div>
