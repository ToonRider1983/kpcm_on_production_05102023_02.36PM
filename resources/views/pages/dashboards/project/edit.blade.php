<x-default-layout>
    ...
    <div class="container">
        <label class="h1 mb-5 fw-bold">Project - Modify</label>
        {{-- {{ route('project.update', $projects->id) }} --}}
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 text-lg-start py-3 col-md-5 text-md-start col-9 text-start pb-5">
                            <label for="">{{ $projects->parent_id }}</label>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-lg-5 text-lg-start py-3 col-md-5 text-md-start col-9 text-start pb-5">
                            <label for="">@if($projects->status_name == 1)
                                Registered
                            @elseif($projects->status_name == 2)
                                OK
                            @elseif($projects->status_name == 3)
                                FREE
                            @elseif($projects->status_name == 4)
                                NG
                            @elseif($projects->status_name == 5)
                                Time Out
                            @endif</label>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-5 text-lg-end col-md-5 text-md-end col-12 text-start pb-5">
                            <select class="form-select companies" name="distributor_id" id="distributor_id" aria-label="Select example">
                                ...
                                @foreach ($company as $company)
                                    <option value="{{ $company->id }}" @if ($company->id == $projects->distributor_id) selected @endif>{{ $company->company_short_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-5 text-lg-end col-md-5 text-md-end col-12 text-start pb-5">
                            <select class="form-select users" name="pic_id" id="pic_id" aria-label="Select example">
                                <option value="{{ $projects->pic_id }}">{{ $projects->customer_name }}</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="card shadow my-4">
                <div class="card-body">
                        ...
                        <div class="col-lg-5 text-lg-start col-md-5 text-md-start col-12 text-start">
                            <div class="input-group mb-5">
                                ...
                                <input type="text" class="form-control" aria-label="Recipient's username" 
                                    aria-describedby="basic-addon2" value="{{ $projects->customer_name }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 text-lg-end col-md-5 text-md-end col-12 text-start pb-5">
                            <input type="text" name="address1"  id="address1"  class="form-control" value="{{ $projects->address1}}">
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-lg-5 text-lg-end col-md-5 text-md-end col-12 text-start pb-5">
                            <input type="text" name="address2"  id="address2" class="form-control" value="{{ $projects->address2}}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row pb-2">
                            ...
                            <span class="col-lg-4 col-md-5 col-12">
                                <input type="text" name="route1"  id="route1" class="form-control" value="{{ $projects->route1}}"></span>
                        </div>
                        <div class="row pb-2">
                            <span class="py-3 col-lg-4 text-lg-end col-md-3 text-md-end col-2 text-end"><i
                                    class="fa-solid fa-down-long fw-bold fs-2 text-gray-800 "></i></span>
                            ...
                            <span class="col-lg-4 col-md-5 col-12">
                                <input type="text" name="route2"  id="route2" class="form-control" value="{{ $projects->route2}}"></span>
                        </div>
                        <div class="row pb-2">
                            <span class="py-3 col-lg-4 text-lg-end col-md-3 text-md-end col-2 text-end"><i
                                    class="fa-solid fa-down-long fw-bold fs-2 text-gray-800 "></i></span>
                            ...
                            <span class="col-lg-4 col-md-5 col-12">
                                <input type="text" name="route3"  id="route3" class="form-control" value="{{ $projects->route3}}"></span>
                        </div>
                        <div class="row">
                            <div class="col-lg-2"></div>
                            <div class="h2 col-lg-3 text-lg-start">
