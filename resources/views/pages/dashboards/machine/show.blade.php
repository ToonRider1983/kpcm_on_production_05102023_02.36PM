<x-default-layout>
    ...
    <div class="container">
        <div class="h2 p-4">Machine Master - Browse</div>
        ...
        <form method="get" action="">
            ...
            <div class="card shadow my-4">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-5 text-lg-start col-md-5 text-md-start col-12 text-start pb-5">
                            <label for=""><i class="fw-bold text-gray-800 fa-solid fa-calendar-days"></i>&nbsp;{{ \Carbon\Carbon::parse($machine->created_at)->format('d/m/Y') }}&nbsp;{{ \Carbon\Carbon::parse($machine->created_at)->format('H:i') }}&nbsp;
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 text-lg-start col-md-5 text-md-start col-12 text-start pb-5">
                            <label for=""><i class="fw-bold text-gray-800 fa-solid fa-calendar-days"></i>&nbsp;{{ \Carbon\Carbon::parse($machine->updated_at)->format('d/m/Y') }}&nbsp;{{ \Carbon\Carbon::parse($machine->updated_at)->format('H:i') }}&nbsp;
            ...
            <a href="{{ url('/machine') }}" class="btn btn-primary btn-sm float-start"
