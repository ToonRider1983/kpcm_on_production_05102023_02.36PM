<x-default-layout>
    ...
    <div class="container">
        ...
        <form action="{{ route('update_history', ['Id' => $key->id, 'machine_id' => $key->machine_id, 'service_idx' => $key->service_idx]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-lg-12 rounded-2 bg-light text-dark my-4 py-3 px-3">
                                        <div class="row">
                                            ...
                                            <div
                                                ...
                                                <label class="pt-3" for="" ="id">{{ $key->service_idx }}</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div
                                    ...
                                    <div class="col-lg-12 rounded-2 bg-light text-dark my-4 py-3 px-3">
                                        <div class="row">
                                            <div
                                                class="fw-bold fs-6 text-gray-800 py-3 col-lg-5 text-lg-end col-md-5 text-md-end col-sm-12 text-sm-start">
                                                Service Date :<b class="h1 pt-4" style="color: red;z-index: 1040;">&#42;</b>
                                            </div>
                                            <div
                                                class="col-lg-5 text-lg-start col-md-5 text-md-start col-sm-12 text-sm-start pb-5">
                                        ...
                                        <div class="row">
                                            <div
                                                class="fw-bold fs-6 text-gray-800 py-3 col-lg-5 text-lg-end col-md-5 text-md-end col-sm-12 text-sm-start">
                                                Service Content :<b class="h1 pt-4" style="color: red;z-index: 1040;">&#42;</b>
                                            </div>
                                            <div
                                                class="col-lg-5 text-lg-start col-md-5 text-md-start col-sm-12 text-sm-start pb-5">
                                            ...
                                            <div
                                                ...
                                                <div class="row">
                                                    <div
                                                        ...
                                                        <label for=""></label>
                                                        <input type="hidden" class="form-control" name="panel_version" id="" value="">
                                                    </div>
                                                    <div
                                                        class="pt-4 col-lg-1 text-lg-center col-md-1 text-md-center col-1 text-center">
            ...
            <a href="{{ route('history', ['Id' => $key->machine_id ]) }}" class="btn btn-primary btn-sm float-start"><i
    ...
    <script>
        ...
        let Mainte_nance_List = ['maint_suction','maint_oilfiter','maint_oilseparator','maint_oil',
        ...
        'maint_fanmotor','maint_oilpump','maint_1st_air','maint_2nd_air','maint_bearindmotor','maint_gauge',
        'maint_magnetic','maint_sensor','maint_maininv','maint_faninv','maint_leakage','chk_filter_replacment','chk_filter_replacment2','chk_filter_replacment3']
        Mainte_nance_List.forEach((item)=>{
            console.log(item+":"+$('input[name="'+item+'"]').val())
            if($(`input[name="${item}"]`).val() == 1){
                $(`input[name="${item}"]:eq(0)`).prop('checked', true);
            }else if($(`input[name="${item}"]`).val() == 3){
                $(`input[name="${item}"]:eq(0)`).prop('checked', true);
                $(`input[name="${item}"]:eq(1)`).prop('checked', true);
            }else if($(`input[name="${item}"]`).val() == 5){
                $(`input[name="${item}"]:eq(0)`).prop('checked', true);
                $(`input[name="${item}"]:eq(2)`).prop('checked', true);
            }else if($(`input[name="${item}"]`).val() == 6){
                $(`input[name="${item}"]:eq(1)`).prop('checked', true);
                $(`input[name="${item}"]:eq(2)`).prop('checked', true);
            }else if($(`input[name="${item}"]`).val() == 7){
                $(`input[name="${item}"]:eq(0)`).prop('checked', true);
                $(`input[name="${item}"]:eq(1)`).prop('checked', true);
                $(`input[name="${item}"]:eq(2)`).prop('checked', true);
            }else{
                $(`input[name="${item}"]:eq(0)`).prop('checked', false);
                $(`input[name="${item}"]:eq(1)`).prop('checked', false);
                $(`input[name="${item}"]:eq(2)`).prop('checked', false);
            }
        });
