                                    ...
                                    <div class="col-lg-12 rounded-2 bg-light text-dark my-4 py-3 px-3">
                                        <div class="row">
                                            ...
                                            <div
                                                ...
                                                <label class="pt-3" for="" name= "service_idx">(New)</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div
                                                class="col-lg-5 text-lg-start col-md-5 text-md-start col-sm-12 text-sm-start pb-5">
                                                <label class="pt-3" for="">{{ $Service_cus }}</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row pt-5 pb-3">
                                        ...
                                        <div class="col-lg-4 text-lg-start col-md-9 text-lg-start col-12 text-start">
                                            ...
                                            <label class="fs-3 fw-bold" for="">OIL FREE COMPRESSOR SERVICE REPORT</label>
                                        ...
                                        <div class="pt-3 col-lg-4 text-lg-end col-md-12 text-md-end col-12">
                                            <div class="row">
                                                <div
                                                    ...
                                                    <label class="fs-5 fw-bold" for="">Unit of Pressure</label>
                                                </div>
                                                <div
                                                    class="col-lg-1 text-lg-end col-md-1 text-md-end col-2 text-start">
                                                    <input class="form-check-input unit_of_pressure border border-gray-500" type="radio" value="1"
                                                ...
                                                <div
                                                    class="col-lg-1 text-lg-end col-md-1 text-md-end col-2 text-start">
                                                    <input class="form-check-input unit_of_pressure border border-gray-500" type="radio" value="2"
                                            ...
                                            <div class="col-lg-10 col-md-12 col-12">
                                                ...
                                                <div class="row">
                                                    <span class="col-lg-5 col-md-5 col-12">
                                                        <div class="row">
                                                            <div
                                                                class="col-lg-4 text-lg-start col-md-5 text-md-start col-12 text-start">
                                                                <label class="py-3 fw-bold fs-6 text-gray-800"
                                                    ...
                                                    <span class="col-lg-7 col-md-7 col-12">
                                                        <div class="row">
                                                            <div
                                                                class="col-lg-2 text-lg-start col-md-2 text-md-start col-12 text-start">
                                                                <label class="py-3 fs-6 text-gray-800"
                                                                    for="">Pressure</label>
                                                            </div>
                                                            <div
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-8 col-9">
                                                                    <div class="input-group mb-5">
                                                                        ...
                                                                        <span class="input-group-text unit_of_pressure"
                                                                            id="basic-addon2">
                                                                            <span class="path1"></span><span
                                                                                class="path2">bar</span>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    class="py-3 col-lg-3 text-lg-start col-md-auto text-md-start col-auto text-end">
                                                ...
                                                <div class="py-2 col-lg-2 col-md-6 col-12">
                                                    <div class="row">
                                                        <div
                                                            class="col-lg-auto text-lg-start col-md-auto text-md-start col-1 text-start">
                                                            <input class="mt-3 form-check-input" type="checkbox"
                                                                name="detail_overhaul_air" value="0" id="">
                                                        </div>
                                                        <div
                                                            class="pt-3 col-lg-auto text-lg-start col-md-auto text-md-start col-11 text-start">
                                                            <label class="text-dark" for="">&nbsp;
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12 mb-4">
                                        <div class="py-3 row rounded-2 bg-light text-dark justify-content-between">
                                            <div class="col-lg-6 col-md-12 col-12">
                                                <div class="row">
                                                    <div class="py-3 col-lg-6 col-md-6 col-12">
                                                        <u class="fw-bold fs-6 text-gray-800" for="">RUNNING CONDITION1</u>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="input-group mb-2"
                                                                    ...
                                                                    <input type="number" class="form-control unit_of_pressure" name="running_oil_temp"/>
                                                    ...
                                                    <div class="py-3 col-lg-6 col-md-6 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="input-group mb-2"
                                                                    data-bs-placement="bottom">
                                                                    <input type="number" class="form-control " name="running_oil_pressure" />
                                                    ...
                                                    <div class="py-3 col-lg-6 col-md-6 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="input-group mb-2"
                                                                    data-bs-placement="bottom">
                                                                    <input type="number" class="form-control"  name="running_1st_dis_temp" />
                                                    ...
                                                    <div class="py-3 col-lg-6 col-md-6 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="input-group mb-2"
                                                                    data-bs-placement="bottom">
                                                                    <input type="number" class="form-control "  name="running_1st_dis_pressure" />
                                                                    <span class="input-group-text unit_of_pressure">bar</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="py-3 col-lg-6 col-md-6 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="input-group mb-2"
                                                                    data-bs-placement="bottom">
                                                                    <input type="number" class="form-control"  name="running_2nd_suc_temp"/>
                                                                    <span class="input-group-text">&#8451;</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="py-3 col-lg-6 col-md-6 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="input-group mb-2"
                                                                    data-bs-placement="bottom">
                                                                    <input type="number" class="form-control " name="running_2nd_dis_pressure" />
                                                                    <span class="input-group-text unit_of_pressure">bar</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="py-3 col-lg-6 col-md-6 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="input-group mb-2"
                                                                    data-bs-placement="bottom">
                                                                    <input type="number" class="form-control" name="running_2nd_dis_temp" />
                                                                    <span class="input-group-text">&#8451;</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-6 col-md-12 col-12">
                                                <div class="row">
                                                    <div class="py-3 col-lg-6 col-md-6 col-12">
                                                        <u class="fw-bold fs-6 text-gray-800" for="">RUNNINGCONDITION2</u>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                        <div class="row">
                                                            <div class="py-3 col-lg-6 col-md-6 col-6">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="input-group mb-2"
                                                                    data-bs-placement="bottom">
                                                                    <input type="number" class="form-control"  name="running_signal"/>
                                                                    <span class="input-group-text">%</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="py-3 col-lg-6 col-md-6 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <input type="number" class="form-control"  name="running_count"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="py-3 col-lg-6 col-md-6 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="input-group mb-2"
                                                                    data-bs-placement="bottom">
                                                                    <input type="number" class="form-control " name="running_pt5_pressure"/>
                                                                    <span class="input-group-text unit_of_pressure">bar</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="py-3 col-lg-3 col-md-6 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="input-group mb-2"
                                                                    data-bs-placement="bottom">
                                                                    <input type="number" class="form-control"name="running_current"/>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-6">
                                                                <div class="col-lg-12 col-md-12 col-12"data-bs-placement="bottom" data-bs-toggle="tooltip" title="(Load Run Time)">
                                                                    <input type="number" class="form-control" name="running_load_count"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <span
                                                                    ...
                                                                    <div
                                                                        class="form-check form-check-custom form-check-solid py-2 px-2">
                                                                        <input name="functions_ocr" class="form-check-input"
                                                                            type="radio" value="1"
                                                                           id="OK" />
                                                                        <label class="form-check-label text-gray-800"
                                                                            for="OK">
                                            ...
                                            <div class="rounded-2 bg-light mb-5 p-3">
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-center col-lg-3 col-md-3 col-2">
                                                        <input type="hidden" class="form-check-input"
                                                            name="maint_solenoid1" id="maint_solenoid" >
                                                    </div>
                                                </div>
                                                <div class="row mb-5">
                                                    <div
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-center col-lg-3 col-md-3 col-2">
                                                        <input type="hidden" class="form-check-input"
                                                            name="maint_shuttle1" id="maint_shuttle" >
                                                    </div>
                                                </div>
                                                <div class="row mb-5">
                                                    <div
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-center col-lg-2 col-md-2 col-2">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="maint_discharge_silenser" id="">
                                                    </div>
                                                    <div
                                                        class="d-flex justify-content-center col-lg-2 col-md-2 col-3">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-center col-lg-3 col-md-3 col-2">
                                                        <input type="hidden" class="form-check-input"
                                                            name="maint_discharge_silenser1" id="maint_discharge_silenser" >
                                                    </div>
                                                </div>
                                                <div class="row mb-5">
                                                    <div
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-center col-lg-3 col-md-3 col-2">
                                                        <input type="hidden" class="form-check-input"
                                                            name="maint_intercooler1" id="maint_intercooler" >
                                                    </div>
                                                </div>
                                                <div class="row mb-5">
                                                    <div
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-center col-lg-3 col-md-3 col-2">
                                                        <input type="hidden" class="form-check-input"
                                                            name="maint_oilpump1" id="maint_oilpump" >
                                                    </div>
                                                </div>
                                                <div class="row mb-5">
                                                    <div
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-center col-lg-3 col-md-3 col-2">
                                                        <input type="hidden" class="form-check-input"
                                                            name="maint_1st_air1" id="maint_1st_air" >
                                                    </div>
                                                </div>
                                                <div class="row mb-5">
                                                    <div
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-center col-lg-3 col-md-3 col-2">
                                                        <input type="hidden" class="form-check-input"
                                                            name="maint_2nd_air1" id="maint_2nd_air" >
                                                    </div>
                                                </div>
                                                <div class="row mb-5">
                                                    <div
